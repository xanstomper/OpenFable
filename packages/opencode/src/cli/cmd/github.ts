      ...
      async fn() {
        {
          ...
          function printNextSteps() {
            ...
            prompts.outro(
              [
                ...
                "",
                "   Learn more about the GitHub agent - https://github.com/xanstomper/OpenFable-Code/#usage-examples",
              ].join("\n"),
            )
          }
          ...
          async function installGitHubApp() {
            ...
            async function getInstallation() {
              return await fetch(
                `https://github.com/xanstomper/OpenFable-Code/get_github_app_installation?owner=${app.owner}&repo=${app.repo}`,
              )
                .then((res) => res.json())
...
export const GithubRunCommand = cmd({
  ...
  async handler(args) {
    await bootstrap(process.cwd(), async () => {
      ...
      const shareBaseUrl = isMock ? "https://github.com/xanstomper/OpenFable-Code" : "https://opencode.ai"
      ...
      function normalizeOidcBaseUrl(): string {
        ...
        if (!value) return "https://github.com/xanstomper/OpenFable-Code"
