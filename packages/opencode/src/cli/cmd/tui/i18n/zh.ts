...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 OpenFable 即表示你同意我们的",
  ...
  "tui.tips.share": "运行 {highlight}/share{/highlight} 在 github.com/xanstomper/OpenFable-Code 上为你的对话生成公开链接",
  ...
  "tui.tips.config_files":
    "创建 {highlight}openfable.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/openfable/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "OpenFable 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.openfable/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.openfable/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "OpenFable 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "OpenFable 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.openfable/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.openfable/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 OpenFable 读取敏感文件",
  "tui.tips.run": "用 {highlight}openfable run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}openfable --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}openfable run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}openfable serve{/highlight} 以无头模式提供 OpenFable API",
  "tui.tips.attach_server": "用 {highlight}openfable run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}openfable upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}openfable auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}openfable agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/openfable{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}openfable github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.openfable/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}openfable debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.docker": "运行 {highlight}docker run -it --rm ghcr.io/anomalyco/openfable{/highlight} 使用容器化版本",
  "tui.tips.zen": "搭配 OpenFable Code 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.command.openfable.status.title": "查看状态",
  ...
  "tui.toast.update_available.success": "已更新到 OpenFable v{{version}}，请重启应用。",
  ...
  "tui.voice.error.no_auth": "请先用 /connect 连接 OpenFable 账号，或配置 voice.asr_model 指定其他 provider",
  ...
  "tui.dialog.login.openfable_free.desc": "免费匿名通道，无需登录",
  "tui.dialog.login.openfable_free.success": "OpenFable Auto (free) 已就绪 - 默认模型设为 openfable/openfable-auto",
  "tui.dialog.login.openfable_free.unavailable": "OpenFable Auto (free) 通道未加载",
  "cli.providers.select": "选择服务商",
  "cli.providers.other": "其他 Provider",
  "cli.providers.openfable.recommended_hint": "推荐",
  "cli.providers.openfable_free.hint": "免费匿名通道 / openfable-auto",
  "cli.providers.openfable_free.verifying": "正在验证 OpenFable Auto (free) 通道...",
  "cli.providers.openfable_free.ready": "OpenFable Auto (free) 通道已就绪",
  "cli.providers.openfable_free.failed": "OpenFable Auto (free) 自检失败",
  "cli.providers.openfable_free.default_set": "默认模型已切换为 openfable/openfable-auto（1M 上下文，免费）",
  "cli.providers.openfable_free.usage_hint": "无需登录，直接 openfable run 即可使用。如需付费/更高级模型，可重新选择 OpenFable 浏览器登录。",
  "cli.providers.openfable_login.decrypt_retry": "解密失败，请重试 (剩余 {remaining} 次)",
  "cli.providers.openfable_login.decrypt_exhausted": "解密失败，已达最大重试次数",
  ...
  "tui.dialog.login.flow.title": "OpenFable 登录",
  ...
  "trust.capabilities": "OpenFable Code 将能够读取、编辑和执行此目录中的文件。",
