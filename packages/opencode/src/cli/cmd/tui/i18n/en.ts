export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using OpenFable, you agree to our ",
  ...
  "tui.tips.share": "Run {highlight}/share{/highlight} to create a public link to your conversation at github.com/xanstomper/OpenFable-Code",
  ...
  "tui.tips.config_files":
    "Create {highlight}openfable.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/openfable/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "OpenFable auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.openfable/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.openfable/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "OpenFable auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "OpenFable uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.openfable/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.openfable/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent OpenFable from reading sensitive files",
  "tui.tips.run": "Use {highlight}openfable run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}openfable --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}openfable run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}openfable serve{/highlight} for headless API access to OpenFable",
  "tui.tips.attach_server": "Use {highlight}openfable run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}openfable upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}openfable auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}openfable agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/openfable{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}openfable github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.openfable/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}openfable debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/anomalyco/openfable{/highlight} for containerized use",
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with OpenFable Code for curated, tested models",
  ...
  "tui.command.openfable.status.title": "View status",
  ...
  "tui.toast.update_available.success": "Successfully updated to OpenFable v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to OpenFable, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.openfable_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.openfable_free.success": "OpenFable Auto (free) is ready — default model set to openfable/openfable-auto",
  "tui.dialog.login.openfable_free.unavailable": "OpenFable Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.openfable.recommended_hint": "recommended",
  "cli.providers.openfable_free.hint": "Anonymous free channel / openfable-auto",
  "cli.providers.openfable_free.verifying": "Verifying OpenFable Auto (free) channel...",
  "cli.providers.openfable_free.ready": "OpenFable Auto (free) channel ready",
  "cli.providers.openfable_free.failed": "OpenFable Auto (free) verification failed",
  "cli.providers.openfable_free.default_set": "Default model set to openfable/openfable-auto (1M context, free)",
  "cli.providers.openfable_free.usage_hint": "No login required — just run openfable. For paid/premium models, choose OpenFable browser login instead.",
  "cli.providers.openfable_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.openfable_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "OpenFable Login",
  ...
  "trust.capabilities": "OpenFable Code will be able to read, edit, and execute files here.",
