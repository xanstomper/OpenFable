...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the OpenFable server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the OpenFable system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global OpenFable configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global OpenFable configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all OpenFable instances, releasing all resources.",
    ...
    .post(
      "/upgrade",
      describeRoute({
        summary: "Upgrade openfable",
        description: "Upgrade openfable to the specified version or latest if not specified.",
