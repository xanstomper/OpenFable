...
const dir = path.join(os.tmpdir(), "openfable-test-data-" + process.pid)
...
process.env["OPENFABLE_TEST_TMPDIR_ROOT"] = fixtureRoot
afterAll(async () => {
...
process.env["OPENFABLE_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["OPENFABLE_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["OPENFABLE_DISABLE_DEFAULT_PLUGINS"] = "true"

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "openfable")
...
delete process.env["OPENFABLE_SERVER_PASSWORD"]
delete process.env["OPENFABLE_SERVER_USERNAME"]
delete process.env["OPENFABLE_HOME"]

// Use in-memory sqlite
process.env["OPENFABLE_DB"] = ":memory:"
