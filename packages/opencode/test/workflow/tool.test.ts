...
describe("WorkflowTool run", () => {
  ...
  const originalFlag = Flag.OPENFABLE_EXPERIMENTAL_WORKFLOW_TOOL
  beforeAll(() => {
    Flag.OPENFABLE_EXPERIMENTAL_WORKFLOW_TOOL = true
  })
  afterAll(() => {
    Flag.OPENFABLE_EXPERIMENTAL_WORKFLOW_TOOL = originalFlag
  })
