      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe(`openfable/${info.name}`)
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("openfable/my-feature")
          }),
        { git: true },
      ),
    )
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.name).toBeDefined()
            expect(info.branch).toStartWith("openfable/")
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("openfable/test-workspace")
