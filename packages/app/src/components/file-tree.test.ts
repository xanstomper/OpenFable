...
beforeAll(async () => {
  ...
  mock.module("@openfable/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openfable/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openfable/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openfable/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
