...
- OpenFable-V2-Pro — 350 input, 41 000 bufret, 250 output-tokens per forespørsel
- OpenFable-V2-Omni — 1000 input, 60 000 bufret, 140 output-tokens per forespørsel
