...
- OpenFable-V2-Pro — 350 di input, 41.000 in cache, 250 token di output per richiesta
- OpenFable-V2-Omni — 1000 di input, 60.000 in cache, 140 token di output per richiesta
