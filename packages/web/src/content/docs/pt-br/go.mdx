...
- OpenFable-V2-Pro — 350 tokens de entrada, 41.000 em cache, 250 tokens de saída por requisição
- OpenFable-V2-Omni — 1000 tokens de entrada, 60.000 em cache, 140 tokens de saída por requisição
