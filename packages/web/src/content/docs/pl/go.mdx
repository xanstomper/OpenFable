...
| OpenFable-V2-Pro  | 1,290               | 3,225              | 6,450              |
| OpenFable-V2-Omni | 2,150               | 5,450              | 10,900             |
...
- OpenFable-V2-Pro — 350 tokenów wejściowych, 41 000 w pamięci podręcznej, 250 tokenów wyjściowych na żądanie
- OpenFable-V2-Omni — 1000 tokenów wejściowych, 60 000 w pamięci podręcznej, 140 tokenów wyjściowych na żądanie
...
| OpenFable-V2-Pro  | openfable-v2-pro  | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| OpenFable-V2-Omni | mimo-v2-omni | `https://opencode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
