...
- OpenFable-V2-Pro — 350 tokens en entrée, 41,000 en cache, 250 tokens en sortie par requête
- OpenFable-V2-Omni — 1000 tokens en entrée, 60,000 en cache, 140 tokens en sortie par requête
