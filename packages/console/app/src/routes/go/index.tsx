...
const models = [
  ...
  { name: "OpenFable-V2-Pro", provider: "Xiaomi OpenFable" },
  { name: "OpenFable-V2-Omni", provider: "Xiaomi OpenFable" },
...
function LimitsGraph(props: { href: string }) {
  ...
  const graph = [
    ...
    { id: "openfable-v2-pro", name: "OpenFable-V2-Pro", req: 1290, d: "150ms" },
