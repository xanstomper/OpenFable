import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@openfable/sdk/v2"
import { SessionTurn } from "@openfable/ui/session-turn"
import { SessionReview } from "@openfable/ui/session-review"
import { DataProvider } from "@openfable/ui/context"
import { FileComponentProvider } from "@openfable/ui/context/file"
import { WorkerPoolProvider } from "@openfable/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openfable/ui/logo"
import { IconButton } from "@openfable/ui/icon-button"
import { ProviderIcon } from "@openfable/ui/provider-icon"
import { iife } from "@openfable/shared/util/iife"
...
import { Tabs } from "@openfable/ui/tabs"
import { MessageNav } from "@openfable/ui/message-nav"
import { FileSSR } from "@openfable/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openfable/ui/pierre/worker").then((m) => ({
